...
namespace seal
{
    ...
    */
    ...
    public:
        ...
        */
        inline void setdata(T* coeff_modulus, size_t& size) noexcept
        {
            util::Pointer<std::uint64_t> d = seal::util::allocate_poly(size, 1, pool_);
            seal::util::set_poly(coeff_modulus, size, 1, d.get());
