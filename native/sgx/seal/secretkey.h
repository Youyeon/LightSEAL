...
namespace seal
{
    ...
    */
    ...
    public:
        ...
        */
        template <typename T>
        inline void set_coeff(T* coeff_modulus, std::size_t size) noexcept
        {
            sk_.set_coeff(coeff_modulus, size);
        }

        /*
        [For SGX]
        Set data(sk_) with given object
        */
        inline void set_data(unsigned char* ptx) noexcept
        {
            sk_.set_data(ptx);
        }
